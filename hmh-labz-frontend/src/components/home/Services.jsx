...
const Services = () => {
  ...
  return (
    <section id="services" className="bg-ink text-paper px-6 md:px-10 lg:px-14 py-28 sm:py-36">
      <Reveal className="mb-20 sm:mb-24 max-w-4xl mx-auto text-left">
        <span className="font-mono uppercase tracking-[0.22em] text-[11px] font-semibold text-terra">03 — How we work</span>
        <h2 className="mt-8 font-sans font-bold leading-[1.04] tracking-[-0.028em]" style={{ fontSize: "clamp(36px, 5.4vw, 68px)" }}>
          Three ways we work<br /><em className="font-serif italic font-normal not-italic text-terra" style={{ fontStyle: 'italic' }}>with you.</em>
        </h2>
        <p className="mt-6 text-paper/55 text-[16px] sm:text-[18px] font-sans leading-[1.6] max-w-[52ch]">
          Each engagement stands alone. Most clients start with the Audit.
        </p>
      </Reveal>

      <div className="grid lg:grid-cols-3 gap-6 items-stretch max-w-7xl mx-auto text-left">
        {tiers.map((t, i) => (

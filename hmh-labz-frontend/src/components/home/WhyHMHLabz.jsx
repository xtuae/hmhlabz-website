...
const WhyHMHLabz = ({ content }) => {
  ...
  return (
    <section className="bg-paper px-6 md:px-10 lg:px-14 py-28 sm:py-36 text-center">
      <Reveal className="max-w-4xl mb-20 sm:mb-24 mx-auto text-center flex flex-col items-center">
        ...
        <p className="mt-8 max-w-[54ch] text-ink/60 text-[16px] sm:text-[18px] leading-[1.6] mx-auto">

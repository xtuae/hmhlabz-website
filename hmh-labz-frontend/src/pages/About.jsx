            ...
            <div className="lg:col-span-7">
              <Reveal>
                ...
                <h1 className="mt-10 sm:mt-12 font-sans font-bold text-ink tracking-tight leading-[0.94]" style={{ fontSize: "clamp(42px, 7vw, 100px)" }}>
                  Strategy + build, <span className="font-serif italic text-terra font-normal">in one team.</span>
                </h1>
                <p className="mt-10 max-w-[48ch] text-ink/65 text-xl sm:text-2xl leading-relaxed">
                  We founded HMH Labz to kill the traditional agency hand-off. The architects who diagnose your problems are the engineers who build the solutions.
                </p>
              </Reveal>
            </div>
              ...
              <Reveal delay={0.2} direction="left">
                <div className="aspect-[4/5] rounded-[3rem] bg-cream border border-ink/10 overflow-hidden relative">
                  <svg viewBox="0 0 400 500" className="absolute inset-0 w-full h-full">
                    ...
                    <text x="200" y="460" fontFamily="Fraunces" fontStyle="italic" fontSize="14" fill="#C2410C" textAnchor="middle">EST. 2020</text>
                  </svg>
                </div>
              </Reveal>
            </div>
              ...
              <div className="md:col-span-5">
                <Reveal>
                  ...
                  <h2 className="mt-8 text-4xl sm:text-6xl font-black leading-tight tracking-tight">
                    Scale shouldn't mean <span className="font-serif italic text-terra font-normal">bloat.</span>
                  </h2>
                </Reveal>
              </div>
              <div className="md:col-span-7">
                <Reveal delay={0.2}>
                  <div className="space-y-10 text-paper/60 text-lg sm:text-xl leading-relaxed font-light">
                    <p>At HMH Labz, we hire only senior technical leads. When you discuss your architecture with us, you're talking to the person who will be writing the PRs. This model reclaimed 84% of ops time for our clients last year.</p>
                  </div>
                </Reveal>
              </div>
            </div>
